...
class ImageFolder(BasePlugin):
    ...
    def generate_image(self, settings, device_config):
        ...
        logger.debug(f"Settings: grid_mode={grid_mode}, pad_image={use_padding}, background_option={background_option}, show_date_taken={show_date_taken}, date_format={date_format!r}, date_size={date_size!r}")
